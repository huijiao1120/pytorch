...
class ShaderRegistry final {
  typedef std::unordered_map<std::string, api::ShaderInfo> ShaderListing;
  typedef std::unordered_map<DispatchKey, std::string> Dispatcher;
  typedef std::unordered_map<std::string, Dispatcher> Registry;
